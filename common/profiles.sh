...
BALANCED_CPU_FREQ_MAX_PERCENT=90
BALANCED_CPU_FREQ_MIN_PERCENT=0
...
BALANCED_GPU_FREQ_MAX_PERCENT=90

# Performance profile: higher ceilings, still leaves thermal protection intact.
PERFORMANCE_GOVERNOR_PREFERENCE="performance schedutil walt interactive"
PERFORMANCE_CPU_FREQ_MAX_PERCENT=100
PERFORMANCE_CPU_FREQ_MIN_PERCENT=20
...
PERFORMANCE_IO_READ_AHEAD_KB=512
